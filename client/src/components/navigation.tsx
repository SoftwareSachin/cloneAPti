          ...
          >
            <div className="max-w-6xl mx-auto px-6 py-4">
              <div style={{display: 'flex', flexDirection: 'column', gap: '16px'}}>
                ...
                <a href="/cursor-demo" style={{color: 'rgba(0,0,0,0.8)', fontSize: '14px', fontWeight: '400', textDecoration: 'none', transition: 'color 0.2s', padding: '4px 0'}} onClick={() => setIsMenuOpen(false)} onMouseEnter={(e) => e.target.style.color = 'rgba(0,0,0,1)'} onMouseLeave={(e) => e.target.style.color = 'rgba(0,0,0,0.8)'}>Cursor Demo</a>
